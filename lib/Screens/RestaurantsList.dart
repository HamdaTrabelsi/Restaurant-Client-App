...
class RestaurantsListScreen extends StatefulWidget {
  static String tag = '/RestaurantsListScreen';

  @override
  _RestaurantsListScreen createState() => _RestaurantsListScreen();
}

class _RestaurantsListScreen extends State<RestaurantsListScreen> {
      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Divider(),
            FutureBuilder(
                future: fireRef.orderBy("title").get(),
